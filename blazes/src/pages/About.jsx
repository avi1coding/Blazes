...
export default function About() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white shadow-sm z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to="/about" className="text-red-600 font-bold border-b-2 border-red-600">About</Link>
      ...
      {/* Hero */}
      <section className="pt-32 pb-24 bg-red-600">
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <h2 className="text-5xl font-black text-gray-900 text-center mb-4">What We Stand For</h2>
          <p className="text-xl text-gray-600 text-center mb-16">Four principles that guide every decision we make at Blazes.</p>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-5xl font-black text-gray-900 mt-2 mb-6">The Science Behind the Fun</h2>
              <p className="text-lg text-gray-600 mb-8">Blazes isn't entertainment with a study label slapped on it. Every mechanic is designed around what learning science says actually works.</p>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-900 rounded-2xl p-8 text-white">
                <div className="text-5xl font-black mb-2">32%</div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h2 className="text-5xl font-black text-gray-900 text-center mb-16">Built by a Student,<br/>for Students</h2>

          <div className="bg-white rounded-3xl p-10 border-2 border-gray-100 flex flex-col md:flex-row gap-10 items-center">
      ...
      <section className="py-24 bg-red-600">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6">
            <Flame className="w-10 h-10 text-red-600" strokeWidth={2.5} />
          </div>
