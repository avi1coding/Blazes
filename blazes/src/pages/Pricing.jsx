      ...
      <nav className="fixed top-0 left-0 right-0 bg-white shadow-sm z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to="/pricing" className="text-red-600 font-bold border-b-2 border-red-600">Pricing</Link>
            <Link to="/login" className="bg-red-600 text-white px-6 py-2 rounded-lg font-bold hover:bg-red-700 transition-colors">Log In</Link>
          </div>
        </div>
      </nav>
      ...
      <section className="pt-32 pb-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Free for students to play. One upgrade unlocks everything.</p>
          </div>
