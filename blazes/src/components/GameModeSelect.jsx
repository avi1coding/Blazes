...
export default function GameModeSelect({ kit: initialKit, user, onBack }) {
  ...
  const gameModes = [
    ...
    },
    {
      ...
      accent: 'amber',
      tags: ['multi'],
      description: 'A pot fills for the whole class every second. The next correct answer cracks it and takes a share set by that player\'s streak, then it refills. Everyone plays at once, and it runs until you end it or your clock runs out.',
      difficulty: 'Easy',
      players: '2-50',
      duration: 'Set by host',
      features: [
